...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if resp.OpenMethodUsed != "vscode" {
		t.Fatalf("expected open_method_used=vscode, got %q: body=%s", resp.OpenMethodUsed, resp.HTTPBody)
	}
	t.Logf("OK: open-dir with vscode succeeded")
}
```